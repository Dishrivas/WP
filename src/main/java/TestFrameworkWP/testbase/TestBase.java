...
public class TestBase 
{
	...
	static {
		...
		extent = new ExtentReports(System.getProperty("user.dir") + "/src/main/java/TestFramework/report/test" + formater.format(calendar.getTime()) + ".html", false);
	}
...
public void loadPropertiesFile() throws IOException{
	...
	PropertyConfigurator.configure(log4jConfPath);
		...
		f1 = new File(System.getProperty("user.dir")+"/src/main/java/TestFramework/config/or.properties");
		file = new FileInputStream(f1);
		OR.load(file);
...
public String getScreenShot(String imageName) throws IOException{
		...
		String imagelocation = System.getProperty("user.dir")+"/src/main/java/com/TestFrameworkWP/screenshot/";
		Calendar calendar = Calendar.getInstance();
		SimpleDateFormat formater = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss");
